...
int main() {
  ...
  for (int i = 0; i < 1500; ++i) {
    ...
    s = generate_random_double(0e0, dso::D2PI * R);
    az = generate_random_double(0e0, dso::D2PI);

    baz1 =
        dso::core::direct_vincenty(lat1, lon1, az, s, a, f, b, lat21, lon21);
    baz2 =
        dso::core::direct_vincenty2(lat1, lon1, az, s, a, f, b, lat22, lon22);
  ...
  baz1 = dso::core::direct_vincenty2(p1_lat, p1_lon, bearing, distance, a, f,
                                      b, lat21, lon21);
  baz2 = dso::core::direct_vincenty2(p1_lat, p1_lon, bearing, distance, a, f,
                                      b, lat22, lon22);
  int deg, min, sign;
  double sec;
