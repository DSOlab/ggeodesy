...
int main() {
  ...
  assert(approxEqual(ngpt::geocentric_latitude<ngpt::ellipsoid::grs80>(0e0), 0e0));
  assert(approxEqual(ngpt::geocentric_latitude<ngpt::ellipsoid::grs80>(ngpt::DPI/2e0), ngpt::DPI/2e0));
  ngpt::Ellipsoid Ell(ngpt::ellipsoid::grs80);
  assert(approxEqual(Ell.geocentric_latitude(-ngpt::DPI/2e0), -ngpt::DPI/2e0));
  ...
  assert(approxEqual(ngpt::reduced_latitude<ngpt::ellipsoid::grs80>(ngpt::DPI/2e0), ngpt::DPI/2e0));
